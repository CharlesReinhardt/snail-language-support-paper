...
\begin{wrapfigure}{r}{0.5\textwidth}
    \begin{center}
        \includegraphics[width=0.5\textwidth]{dap-high-level.png}
        \caption{
            \centering 
...
\begin{itemize}
    \item Why Version Control?
        \begin{itemize}
            \item Life without version control
            \item Life with version control
        \end{itemize}
    \item Types of version control?
        \begin{itemize}
            \item mainly monolithic vs distributed
        \end{itemize}
    \item Git and GitHub
        \begin{itemize}
            \item History of Git
            \item Why Git/what makes Git unique
            \item What is GitHub
            \item Why GitHub/what makes GitHub unique (can even just be that GitHub is super dominant)
        \end{itemize}
    \item Git and GitHub in Snail Language Support
        \begin{itemize}
            \item code stored in a repository
            \item sharing branches
            \item pull requests/code reviews
            \item Snail Language Support Paper GitHub
        \end{itemize}
\end{itemize}
