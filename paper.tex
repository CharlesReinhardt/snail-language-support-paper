...
\definecolor{darkred}{HTML}{690101}
\definecolor{lightgray}{HTML}{EEEEEE}
\definecolor{lightblue}{HTML}{146ab0}
\definecolor{lightpurple}{HTML}{a555ab}

\colorlet{punct}{darkred}
\colorlet{background}{lightgray}
\colorlet{delim}{lightblue}
\colorlet{numb}{lightpurple}
...
\definecolor{green}{HTML}{2d6e21}
\definecolor{red}{HTML}{d41313}
\definecolor{blue}{HTML}{1323d4}
\definecolor{purple}{HTML}{7d13d4}

\colorlet{comment}{green}
\colorlet{string}{red}
\colorlet{keyword1}{blue}
\colorlet{keyword2}{purple}
...
\lstdefinelanguage{TypeScript}{
    ...
    keywords={if, else, import, as, from, return, await, try, catch, throw, finally, number, string, true, false, undefined, new},
    otherkeywords={=>},
    keywordstyle=\color{keyword1},
    keywords=[3]{const, let, interface, function, async},
    keywordstyle=[3]\color{keyword2},
}

\lstdefinelanguage{Reason}{
    basicstyle=\normalfont\ttfamily,
    numbers=left,
    numberstyle=\scriptsize,
    stepnumber=1,
    ...
    morestring=[b]",
    stringstyle=\color{string}\ttfamily,
    keywords={open, ref, try},
    otherkeywords={=>, \%},
    keywordstyle=\color{keyword1},
    keywords=[3]{let, module, program},
    keywordstyle=[3]\color{keyword2}
}
...
\author{Charles Reinhardt \\ Dr. Kevin Angstadt}
...
\section{The \lstinline{snaildap.re} File}
    ...
    \lstinputlisting[language=Reason]{
