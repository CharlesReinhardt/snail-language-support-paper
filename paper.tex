...
\begin{itemize}
    \item What is software documentation?
        \begin{itemize}
            \item types of documentation: Internal vs external
            \item forms of documentation: text, images, diagrams
        \end{itemize}
    \item Documentation in Snail Language Support
        \begin{itemize}
            \item USING documentation for development
                \begin{itemize}
                    \item VS Code docs
                    \item git docs
                    \item markdown and mermaid docs
                \end{itemize}
            \item CREATING documentation for the extension
                \begin{itemize}
                    \item markdown
                    \item mermaid diagrams
                    \item drawio
                    \item creating documentation is hard
                \end{itemize}
        \end{itemize}
\end{itemize}
